...
public class Carro {
    ...
    private Carro(Motorista motorista, String placa, Cor cor) {
        if (null == placa) {
            throw new NullPointerException("Todo carro precisa de uma placa");
        }
        if (null == cor) {
            throw new NullPointerException("Todo carro precisa de uma cor");
        }
    ...
    public boolean isMotoristaIdoso() {
        return (null != motorista && 55 <= motorista.getIdade());
    }
